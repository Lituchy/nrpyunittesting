...
class TestGlobals(unittest.TestCase):
    ...
    def setUp(self):
        self.path = r'/home/kevin/virtpypy/nrpyunittesting/GiRaFFE_HO/tests'
    ...
    def test_globals(self):
        ...
        self.function = 'GiRaFFE_Higher_Order_v2()'
        
        self.global_list = ['gammaUU', 'gammadet', 'SevolParenUD', 'Stilde_rhsD', 'AevolParen', 'PevolParenU', 'A_rhsD', 'psi6Phi_rhs']
        
        self.initialization_string = """"""
        
        self.trusted_values_dict_name = 'GiRaFFE_HO_v2__GiRaFFE_Higher_Order_v2__globals'
