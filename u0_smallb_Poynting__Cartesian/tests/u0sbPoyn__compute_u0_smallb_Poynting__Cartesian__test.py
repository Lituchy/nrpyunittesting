...
class TestGlobals(unittest.TestCase):
    ...
    def setUp(self):
        self.path = r'/home/kevin/virtpypy/nrpyunittesting/u0_smallb_Poynting__Cartesian/tests'
    ...
    def test_globals(self):
        ...
        self.module = 'u0_smallb_Poynting__Cartesian.u0_smallb_Poynting__Cartesian'

        self.module_name = 'u0sbPoyn'

        self.function = 'compute_u0_smallb_Poynting__Cartesian()'
        
        self.global_list = ['g4DD', 'u0', 'uD', 'uBcontraction', 'uU', 'smallb4U', 'g4UU', 'smallb4D', 'smallb2etk', 'PoynSU']
        
        self.initialization_string = """"""
        
        self.trusted_values_dict_name = 'u0sbPoyn__compute_u0_smallb_Poynting__Cartesian__globals'
