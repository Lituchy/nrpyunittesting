...
import unittest
import logging
from UnitTesting.run_test_new import run_test_new
...
class TestGlobals(unittest.TestCase):
    ...
    def test_globals(self):
        ...
        global_list = ['g4DD', 'u0', 'uD', 'uBcontraction', 'uU', 'smallb4U', 'g4UU', 'smallb4D', 'smallb2etk',
                       'PoynSU']

        function_list = ['compute_u0_smallb_Poynting__Cartesian()']

        run_test_new(self, path, module, module_name, global_list, function_list)
