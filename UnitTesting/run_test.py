...
from UnitTesting.new_simplify_and_evaluate_sympy_expressions import new_simplify_and_evaluate_sympy_expressions
...
def run_test(self, mod_dict, trusted_values_dict, locs):
    ...
    for mod in result_dict:
        ...
        value_dict = new_simplify_and_evaluate_sympy_expressions(new_dict, first_time)
